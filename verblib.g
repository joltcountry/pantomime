!----------------------------------------------------------------------------
!
!         Hugo Verb Grammar v3.1.01.1 by Kent Tessman (c) 1995-2004
...
verb "talk", "speak", "converse"
	*                                                       DoTalk
	* "to"/"with" living                                    DoTalk
	* "to"/"with" living "about" anything                   DoTalk
	* "about" anything                                      DoAskQuestion
